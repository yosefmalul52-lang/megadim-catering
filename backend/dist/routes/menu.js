...
router.get('/', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const menuItems = yield MenuItem.find({});
        res.status(200).json({
            success: true,
            data: menuItems,
...
router.get('/category/:categoryName', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const menuItems = yield MenuItem.find({ category: categoryName });
        res.status(200).json({
            success: true,
            data: menuItems,
            count: menuItems.length,
...
router.post('/', require('../middleware/auth').authenticate, (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
...
router.put('/:id', require('../middleware/auth').authenticate, (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const { id } = req.params;
...
router.delete('/:id', require('../middleware/auth').authenticate, (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        if (!id) {
            return res.status(400).json({
        ...
        const deletedItem = yield MenuItem.findByIdAndDelete(id);
        if (!deletedItem) {
            return res.status(404).json({
                success: false,
                error: 'Menu item not found'
