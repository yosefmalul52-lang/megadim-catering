...
/** Map weekly menu category key to dictionary category. */
export function dictionaryCategoryForMenuKey(menuKey: MenuCategoryKey): B2BDictionaryCategory {
  if (menuKey === 'carb1' || menuKey === 'carb2') return 'carb';
